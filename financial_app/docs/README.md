# Система учета финансов ВШЭ-Банк

## Домашняя работа №2 - Паттерны проектирования

### Описание проекта

Система учета финансов для ВШЭ-Банка, разработанная с применением принципов Domain-Driven Design (DDD), паттернов проектирования GoF, принципов SOLID и GRASP.
...
## Реализованные паттерны (10 паттернов)

### 1. **Factory Method** (Порождающий)
...
### 8. **Template Method** (Поведенческий)
...
Проект реализован на максимальный балл:

* ✅ **3 балла** - полная реализация основных требований
* ✅ **4 балла** - 10 паттернов (8\*0.5 = 4)
* ✅ **2 балла** - соблюдение SOLID и GRASP
* ✅ **1 балл** - использование DI контейнера
